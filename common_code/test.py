...
parameters2 = {
	...
	'measure': 'revenue', # 'units'/'revenue' revenue = net revenue in cents
	...
	'country': 'SE_ASIA', # reference: https://app.sensortower.com/api/docs/static/country_ids.json (country) https://app.sensortower.com/api/docs/static/region_ids.json (region)
	'limit': 100, # max: 2000
	'offset': 100,
	'date': '2022-01-01',
	'end_date': '2022-11-30',
...
output_file = "2022_sea_game_top_revenue_101-200.csv"
